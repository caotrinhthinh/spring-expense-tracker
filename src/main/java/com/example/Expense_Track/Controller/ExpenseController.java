...
import com.example.Expense_Track.Service.ExpenseService;
...
public class ExpenseController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Expense> updateExpense(@PathVariable("id") String id, @RequestBody Expense newExpense) {
